...
<p>Wie ich in meiner Diplomarbeit über den EU-US-Privay Shield dargestellt habe, hat ein zu großes Netzwerk eine sehr hohe Wechseldynamik seiner Systemelemente zur Folge. Dies lässt sich am Beispiel Facebook zeigen, das von nun an Teil des Meta-Netzwerkes ist, und somit auch Meta genannt wird. Google+ hat es hingegen nie geschafft, über die Reißleine hinweg Netzwerkkapazitäten einzunehmen, die den Marktanteil von Meta-Facebook bedroht hätten. Vielleicht liegt dies an der geschickten Marketingstrategie, die hinter dem Projekt, seit es kommerzielle Bahnen angenommen hat, steckt.</p>
